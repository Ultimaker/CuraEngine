...
MeshPathConfigs::MeshPathConfigs(const SliceMeshStorage& mesh, const coord_t layer_thickness, const LayerIndex& layer_nr, const std::vector<Ratio>& line_width_factor_per_extruder)
    : inset0_config(
        ...
        SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_wall_0"),
    ...
    , insetX_config(
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_wall_x"),
    ...
    , bridge_inset0_config(
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("bridge_wall_speed"),
                            .acceleration = mesh.settings.get<Acceleration>("acceleration_wall_0"),
                            .jerk = mesh.settings.get<Velocity>("jerk_wall_0") },
          true // is_bridge_path
          ,
    ...
    , skin_config(
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_topbottom"),
    ...
    , bridge_skin_config( // use bridge skin flow, speed and fan
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("bridge_skin_speed"),
                            .acceleration = mesh.settings.get<Acceleration>("acceleration_topbottom"),
                            .jerk = mesh.settings.get<Velocity>("jerk_topbottom") },
          true // is_bridge_path
          ,
    ...
    , bridge_skin_config2( // use bridge skin 2 flow, speed and fan
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("bridge_skin_speed_2"),
                            .acceleration = mesh.settings.get<Acceleration>("acceleration_topbottom"),
                            .jerk = mesh.settings.get<Velocity>("jerk_topbottom") },
          true // is_bridge_path
          ,
    ...
    , bridge_skin_config3( // use bridge skin 3 flow, speed and fan
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("bridge_skin_speed_3"),
                            .acceleration = mesh.settings.get<Acceleration>("acceleration_topbottom"),
                            .jerk = mesh.settings.get<Velocity>("jerk_topbottom") },
          true // is_bridge_path
          ,
    ...
    , roofing_config(
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_roofing"),
    ...
    , ironing_config(
          ...
          SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_ironing"),
...

{
    ...
    for (int combine_idx = 0; combine_idx < MAX_INFILL_COMBINE; combine_idx++)
    {
        infill_config.emplace_back(
            ...
            SpeedDerivatives{ .speed = mesh.settings.get<Velocity>("speed_infill"),
...
PathConfigStorage::PathConfigStorage(const SliceDataStorage& storage, const LayerIndex& layer_nr, const coord_t layer_thickness)
    ...
    , raft_base_config(
          ...
          Ratio(1.0),
          SpeedDerivatives{ .speed = raft_base_train.settings.get<Velocity>("raft_base_speed"),
    ...
    , raft_interface_config(
          ...
          Ratio(1.0),
          SpeedDerivatives{ .speed = raft_interface_train.settings.get<Velocity>("raft_interface_speed"),
    ...
    , raft_surface_config(
          ...
          Ratio(1.0),
          SpeedDerivatives{ .speed = raft_surface_train.settings.get<Velocity>("raft_surface_speed"),
    ...
    , support_roof_config(
          ...
          SpeedDerivatives{ .speed = support_roof_train.settings.get<Velocity>("speed_support_roof"),
    ...
    , support_bottom_config(
          ...
          SpeedDerivatives{ .speed = support_bottom_train.settings.get<Velocity>("speed_support_bottom"),
                            ...
                            .jerk = support_bottom_train.settings.get<Velocity>("jerk_support_bottom") })
{
    ...
    for (size_t extruder_nr = 0; extruder_nr < extruder_count; extruder_nr++)
    {
        ...
        travel_config_per_extruder.emplace_back(
            ...
            0,
            0.0,
            SpeedDerivatives{ .speed = train.settings.get<Velocity>("speed_travel"),
        ...
        skirt_brim_config_per_extruder.emplace_back(
            ...
            SpeedDerivatives{ .speed = train.settings.get<Velocity>("skirt_brim_speed"),
        ...
        prime_tower_config_per_extruder.emplace_back(
            ...
            SpeedDerivatives{ .speed = train.settings.get<Velocity>("speed_prime_tower"),
    ...
    for (int combine_idx = 0; combine_idx < MAX_INFILL_COMBINE; combine_idx++)
    {
        support_infill_config.emplace_back(
            ...
            support_infill_train.settings.get<Ratio>("support_material_flow") * ((layer_nr == 0) ? support_infill_train.settings.get<Ratio>("material_flow_layer_0") : Ratio(1.0))
                * (combine_idx + 1),
            SpeedDerivatives{ .speed = support_infill_train.settings.get<Velocity>("speed_support_infill"),
