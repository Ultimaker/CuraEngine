...
void PathConfigStorage::MeshPathConfigs::smoothAllSpeeds(GCodePathConfig::SpeedDerivatives first_layer_config, const GCodePathConfig::SpeedDerivatives& first_layer_wall_config, const LayerIndex& layer_nr, const LayerIndex& max_speed_layer)
{
    ...
    { // meshes
        for (size_t mesh_idx = 0; mesh_idx < storage.meshes.size(); mesh_idx++)
        {
            ...
            GCodePathConfig::SpeedDerivatives initial_layer_wall_speed_config{
                    mesh.settings.get<Velocity>("speed_walls_layer_0")
                    , mesh.settings.get<Acceleration>("acceleration_walls_layer_0")
                    , mesh.settings.get<Velocity>("jerk_walls_layer_0")
            };
