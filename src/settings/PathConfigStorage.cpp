...
GCodePathConfig createPerimeterGapConfig(const SliceMeshStorage& mesh, int layer_thickness, int initial_layer_nr, int layer_nr)
{
    ...
    return GCodePathConfig(
            ...
            , layer_thickness
            , (layer_nr == initial_layer_nr)? mesh.getSettingInPercentage("material_flow_layer_0") : mesh.getSettingInPercentage("material_flow")
...
PathConfigStorage::MeshPathConfigs::MeshPathConfigs(const SliceMeshStorage& mesh, int layer_thickness, int initial_layer_nr, int layer_nr, const std::vector<double>& line_width_factor_per_extruder)
: initial_layer_nr(initial_layer_nr)
, inset0_config(
...
, perimeter_gap_config(createPerimeterGapConfig(mesh, layer_thickness, initial_layer_nr, layer_nr))
{
...
: initial_layer_nr(-Raft::getTotalExtraLayers(storage))
...
, raft_base_config(
            ...
            , (layer_nr == initial_layer_nr)? adhesion_extruder_train->getSettingInPercentage("material_flow_layer_0") : adhesion_extruder_train->getSettingInPercentage("material_flow")
...
, support_roof_config(
            ...
            , layer_thickness
            , (layer_nr == initial_layer_nr)? support_roof_train->getSettingInPercentage("material_flow_layer_0") : support_roof_train->getSettingInPercentage("material_flow")
...
, support_bottom_config(
            ...
            , layer_thickness
            , (layer_nr == initial_layer_nr)? support_bottom_train->getSettingInPercentage("material_flow_layer_0") : support_bottom_train->getSettingInPercentage("material_flow")
        ...
        )
{
    ...
    for (int extruder_nr = 0; extruder_nr < extruder_count; extruder_nr++)
    {
        ...
        skirt_brim_config_per_extruder.emplace_back(
                ...
                , layer_thickness
                , (layer_nr == initial_layer_nr)? train->getSettingInPercentage("material_flow_layer_0") : train->getSettingInPercentage("material_flow")
    ...
    {
        mesh_configs.emplace_back(mesh_storage, layer_thickness, initial_layer_nr, layer_nr, line_width_factor_per_extruder);
    }
