...
public:
    ...
    public:
        ...
        void smoothAllSpeeds(GCodePathConfig::SpeedDerivatives first_layer_config, const GCodePathConfig::SpeedDerivatives& first_layer_wall_config, const LayerIndex& layer_nr, const LayerIndex& max_speed_layer);
    };
