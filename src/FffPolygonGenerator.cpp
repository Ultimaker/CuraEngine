    ...
    else
    {
        ...
        )
        {
            ...
            else
            {
                ...
                bool use_new_cross_3d_generator = true;
                mesh.cross_fill_provider = new SierpinskiFillProvider(mesh.bounding_box, mesh.settings.get<coord_t>("infill_line_distance"), mesh.settings.get<coord_t>("infill_line_width"), use_new_cross_3d_generator);
            }
        }
