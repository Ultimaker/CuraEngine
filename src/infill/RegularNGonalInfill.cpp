...
namespace cura::RegularNGonalInfill
{

OpenLinesSet zigZaggify(
...
OpenLinesSet fitLines(const OpenLinesSet& raw_lines, const bool zig_zaggify, const Shape& in_outline)
{
    OpenLinesSet result;
...
void generateHoneycombInfill(OpenLinesSet& result_lines, const bool zig_zaggify, const coord_t line_distance, const Shape& in_outline, const coord_t line_width)
{
    ...
    result_lines = fitLines(raw_lines, zig_zaggify, in_outline);
}
