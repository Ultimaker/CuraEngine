...
protected:
     ...
     */
    void calculateTopSkin(const SliceLayerPart& part, const double min_infill_area, Polygons& upskin);
     ...
     */
    void calculateBottomSkin(const SliceLayerPart& part, const double min_infill_area, Polygons& downskin);
