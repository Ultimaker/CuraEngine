...
#pragma omp master
    ...
    { // CuraEngine analyse [json] [output.gv] [engine_settings] -[p|i|e|w]
        ...
        else
        {
            log("\n");
            log("usage:\n");
            log("CuraEngine analyse <fdmPrinter.def.json> <output.gv> <engine_settings_list> -[p|i|e|w]\n");
            log("\tGenerate a grpah to visualize the setting inheritance structure.\n");
            log("\t<fdmPrinter.def.json>\n\tThe base seting definitions file.\n");
            log("\t<output.gv>\n\tThe output file.\n");
            log("\t<engine_settings_list>\n\tA text file with all setting keys used in the engine, separated by newlines.\n");
            log("\t-[p|i|e|w]\n\tOptions for what to include in the visualization\n");
            log("\t\tp\tVisualize the parent-child relationship.\n");
            log("\t\ti\tVisualize inheritance function relationships.\n");
