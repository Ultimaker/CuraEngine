...
void ArcusCommunication::sendPrintTimeMaterialEstimates() const
{
    ...
    message->set_time_retract(time_estimates[static_cast<unsigned char>(PrintFeatureType::MoveRetracted)]);
    ...
    message->set_time_travel(time_estimates[static_cast<unsigned char>(PrintFeatureType::MoveUnretracted)]);
    message->set_time_prime_tower(time_estimates[static_cast<unsigned char>(PrintFeatureType::PrimeTower)]);
    message->set_time_travel(time_estimates[static_cast<unsigned char>(PrintFeatureType::MoveWhileRetracting)]);
    message->set_time_travel(time_estimates[static_cast<unsigned char>(PrintFeatureType::MoveWhileUnretracting)]);
