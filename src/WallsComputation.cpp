 ...
 */
void WallsComputation::generateWalls(SliceLayerPart* part, debug::SectionType section_type)
{
 ...
 * generateWalls only reads and writes data for the current layer
 */
void WallsComputation::generateWalls(SliceLayer* layer, debug::SectionType section)
{
