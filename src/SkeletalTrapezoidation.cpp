...
void SkeletalTrapezoidation::generateToolpaths(ToolPaths& generated_toolpaths, bool filter_outermost_central_edges)
{
...
void SkeletalTrapezoidation::addToolpathSegment(const ExtrusionJunction& from, const ExtrusionJunction& to, bool is_odd, bool force_new_path)
{
    ...
    ToolPaths& generated_toolpaths = *p_generated_toolpaths;
