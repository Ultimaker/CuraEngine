    ...
    cura::parallel_for<coord_t>(
        ...
        [&](const LayerIndex layer_idx)
        {
            ...
            Polygons overhang_regular = TreeSupportUtils::safeOffsetInc(
                ...
                &config_.simplifier);
            Polygons remaining_overhang = mesh.overhang_areas[layer_idx + z_distance_delta_]
            ...
            else
            {
                if (use_fake_roof_)
                {
                    storage.support.supportLayers[layer_idx]
                        .fillInfillParts(layer_idx, support_roof_drawn_, config_.support_line_width, support_roof_line_distance_, config_.maximum_move_distance);
