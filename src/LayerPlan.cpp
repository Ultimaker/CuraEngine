...
void LayerPlan::addPolygon(const Polygons& polygons, unsigned int poly_idx, unsigned int start_idx, const GCodePathConfig& config, PolygonFlowAdjuster* wall_overlap_computation, coord_t wall_0_wipe_dist, bool spiralize, float flow_ratio, bool always_retract)
{
