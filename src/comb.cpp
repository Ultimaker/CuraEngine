...
void LinePolygonsCrossings::getBasicCombingPath(PolyCrossings& polyCrossings, CombPath& combPath) 
{
    ...
    combPath.push_back(transformation_matrix.unapply(Point(polyCrossings.min.x - abs(dist_to_move_boundary_point_outside), transformed_startPoint.Y)));
    ...
    combPath.push_back(transformation_matrix.unapply(Point(polyCrossings.max.x + abs(dist_to_move_boundary_point_outside), transformed_startPoint.Y))); 
}
