...
void GCodePlanner::addTravel(Point p)
{
    ...
    if (comb != nullptr && !bypass_combing && lastPosition != no_point)
    {
        ...
        combed = comb->calc(lastPosition, p, combPaths, was_inside, is_inside, retraction_config.retraction_min_travel_distance, via_outside_makes_combing_fail, over_inavoidable_obstacles_makes_combing_fail);
        if (combed)
        {
