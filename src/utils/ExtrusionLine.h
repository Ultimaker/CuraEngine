...
struct ExtrusionLine
{
    ...
    /*!
     * Cut this polyline up into pieces.
     *
     * Cut up this extrusion-line and put the resulting (series of) cut-up extrusion-lines into the results.
     *
     * @param tool The shape of the cut.
     * @param p_results Pointer to the vector the results will be placed in. Will not erase previous results.
     */
    void cutPolyline(const Polygons& tool, std::vector<ExtrusionLine>* p_results) const;
};
