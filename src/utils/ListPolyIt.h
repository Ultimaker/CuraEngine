...
public:
     ...
     */
    static void convertPolygonsToLists(const Polygons& polys, ListPolygons& result, bool remove_duplicates = false);
    /*!
     * Convert Polygons to ListPolygons
     * 
     * \param polys The polygons to convert
     ...
     * \param remove_duplicates Whether to skip the conversion of duplicate consecutive points in the input
     */
    static void convertPolygonToList(ConstPolygonRef poly, ListPolygon& result, bool remove_duplicates = false);
    /*!
     ...
     * \param remove_duplicates Whether to skip the conversion of duplicate consecutive points in the input
     */
    static void convertListPolygonsToPolygons(const ListPolygons& list_polygons, Polygons& polygons, bool remove_duplicates = false);
    /*!
     * Convert ListPolygons to Polygons
     * 
     * \param list_polygons The polygons to convert
     ...
     * \param remove_duplicates Whether to skip the conversion of duplicate consecutive points in the input
     */
    static void convertListPolygonToPolygon(const ListPolygon& list_polygon, PolygonRef polygon, bool remove_duplicates = false);
