...
// void PrintPlan::handle(LayerPlan& layer_plan, GCodeExporter& gcode, PlanExporter& exporter)
// {
//     push(layer_plan);
//
...
void PrintPlan::appendLayerPlan(const std::shared_ptr<LayerPlan>& layer_plan)
{
...
// void PrintPlan::flush(PlanExporter& exporter)
// {
...
// void PrintPlan::addConnectingTravelMove(LayerPlan* prev_layer, const LayerPlan* newest_layer)
// {
...
// void PrintPlan::processFanSpeedLayerTime()
// {
...
// void PrintPlan::insertPreheatCommand(ExtruderPlan& extruder_plan_before, const Duration time_before_extruder_plan_end, const size_t extruder_nr, const Temperature temp)
// {
...
// Preheat::WarmUpResult PrintPlan::computeStandbyTempPlan(std::vector<ExtruderPlan*>& extruder_plans, unsigned int extruder_plan_idx)
// {
...
//
//
// void PrintPlan::handleStandbyTemp(std::vector<ExtruderPlan*>& extruder_plans, unsigned int extruder_plan_idx, double standby_temp)
// {
//     ExtruderPlan& extruder_plan = *extruder_plans[extruder_plan_idx];
//     size_t extruder = extruder_plan.extruder_nr_;
...
// }
//
// void PrintPlan::insertPreheatCommand_multiExtrusion(std::vector<ExtruderPlan*>& extruder_plans, unsigned int extruder_plan_idx)
// {
//     ExtruderPlan& extruder_plan = *extruder_plans[extruder_plan_idx];
...
// void PrintPlan::insertPrintTempCommand(ExtruderPlan& extruder_plan)
// {
...
// }
//
// void PrintPlan::insertFinalPrintTempCommand(std::vector<ExtruderPlan*>& extruder_plans, unsigned int last_extruder_plan_idx)
// {
...
//     }
//
//     double heated_post_travel_time = 0; // The time after the last extrude move toward the end of the extruder plan during which the nozzle is stable at the final print
//     temperature { // compute heated_post_travel_time
//         unsigned int path_idx;
...
//     }
//
//     double time_window = 0; // The time window within which the nozzle needs to heat from the initial print temp to the printing temperature and then back to the final print
//     temp;
...
// void PrintPlan::insertTempCommands()
// {
