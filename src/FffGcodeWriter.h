...
private:
     ...
     * \param extrusionWidth extrusionWidth
     */
    void processSkin(GCodePlanner& gcodeLayer, SliceMeshStorage* mesh, SliceLayerPart& part, unsigned int layer_nr, double infill_overlap, int fillAngle, int extrusionWidth);
