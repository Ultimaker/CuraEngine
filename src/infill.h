...
public:
     ...
     */
    void generate(Polygons& result_polygons, Polygons& result_lines, const SierpinskiFillProvider* cross_fill_provider = nullptr, const RibbedVaultLayer* ribbed_support_vault_layer = nullptr, const SliceMeshStorage* mesh = nullptr);

private:
    /*!
     * Generate the infill pattern without the infill_multiplier functionality
     */
    void _generate(Polygons& result_polygons, Polygons& result_lines, const SierpinskiFillProvider* cross_fill_pattern = nullptr, const RibbedVaultLayer* ribbed_support_vault_layer = nullptr, const SliceMeshStorage* mesh = nullptr);
     ...
     * \param result (output) The resulting polygons
     */
    void generateRibbedInfill(const RibbedVaultLayer* ribbed_vault_layer, Polygons& result_lines);
