...
INSTANTIATE_TEST_SUITE_P(
    ...
    WriteInt2mmTest,
    testing::Values(-10000, -1000, -100, -10, -1, 0, 1, 10, 100, 1000, 10000, 123456789, std::numeric_limits<int32_t>::max() / 1001)); // For max integer test, divide by 1000 since
                                                                                                                                       // MM2INT multiplies by 1000 which would
                                                                                                                                       // cause an overflow.
...
INSTANTIATE_TEST_SUITE_P(
    WriteDoubleToStreamTestInstantiation,
