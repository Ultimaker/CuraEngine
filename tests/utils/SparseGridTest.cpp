...
INSTANTIATE_TEST_CASE_P(GetNearbyInstantiation,
                        GetNearbyTest,
                        testing::Values(GetNearbyParameters({ Point(0, 100) }, std::unordered_set<Point>(), std::unordered_set<Point>({ Point(0, 100) })), // A far point.
...
INSTANTIATE_TEST_SUITE_P(GetNearestInstantiation,
                         GetNearestTest,
                         testing::Values(GetNearestParameters(std::vector<Point>({ Point(95, 100), Point(103, 100), Point(200, 100) }), new Point(103, 100)), // Choose the nearest out of 3 points.
                                         GetNearestParameters(std::vector<Point>({ Point(95, 100), Point(98, 100), Point(106, 100) }),
                                                              new Point(106, 100),
                                                              [](const typename SparsePointGridInclusive<Point>::Elem& elem) -> bool { return elem.point.X > 100; }), // With a filter.
