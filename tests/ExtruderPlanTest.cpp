...
public:
        ...
        , travel_config(PrintFeatureType::MoveCombing, 0, 100, 0.0_r, SpeedDerivatives(120.0, 5000.0, 30.0))
    {
        ...
        lines.assign({ GCodePath(extrusion_config, mesh, SpaceFillType::Lines, flow_1, width_1, no_spiralize, speed_1),
        ...
        decreasing_flow.assign({ GCodePath(extrusion_config, mesh, SpaceFillType::Lines, flow_12, width_1, no_spiralize, speed_1),
                                 GCodePath(travel_config, mesh, SpaceFillType::Lines, flow_1, width_1, no_spiralize, speed_1),
        ...
        decreasing_speed.assign({ GCodePath(extrusion_config, mesh, SpaceFillType::Lines, flow_1, width_1, no_spiralize, speed_12),
                                  GCodePath(travel_config, mesh, SpaceFillType::Lines, flow_1, width_1, no_spiralize, speed_1),
