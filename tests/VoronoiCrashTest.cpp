...
const std::vector<std::string> polygon_filenames = {
    ...
    std::filesystem::path(__FILE__).parent_path().append("voronoi_crash_resources/slice_polygon_009.txt").string(),
//    std::filesystem::path(__FILE__).parent_path().append("voronoi_crash_resources/slice_polygon_010.txt").string(),
};
