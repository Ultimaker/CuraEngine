...
//        socket_->registerMessageType(&plugins::proto::PluginRequest::default_instance());
...
//
//        proto::PluginRequest args{};
//        args.set_id(slot_id);

//        socket_->sendMessage(std::make_shared<proto::PluginRequest>(args));
