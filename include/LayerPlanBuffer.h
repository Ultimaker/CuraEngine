...
class LayerPlanBuffer
{
    ...
    static constexpr Duration extra_preheat_time = 0.0_s; //!< Time to start heating earlier than computed to avoid accummulative discrepancy between actual heating times and computed ones.
