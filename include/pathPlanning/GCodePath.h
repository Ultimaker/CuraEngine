...
struct GCodePath
{
    ...
    std::optional<std::vector<Point2F>> idlabel_uv_per_point = std::nullopt; //!< If this path is part of an ID-label, contains for each path-point an UV-point into the label-texture.
