...
class GCodeExporter : public NoCopy, public PlanExporter
{
#ifdef BUILD_TESTS
...
public:
     ...
     * This is used primarily during better specification of temperatures in PrintPlan::insertPreheatCommand
     *
