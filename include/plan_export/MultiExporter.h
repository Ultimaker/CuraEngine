...
class MultiExporter : public PlanExporter
{
public:
    void appendExporter(const std::shared_ptr<PlanExporter> exporter);
...
private:
    std::vector<std::shared_ptr<PlanExporter>> exporters_;
};
