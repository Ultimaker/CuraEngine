...
struct FlowLimitedPath
{
    ...
    {
        return original_gcode_path_data->flow* original_gcode_path_data->config.line_width * original_gcode_path_data->config.layer_thickness * original_gcode_path_data->config.getFlowRatio();
    }
