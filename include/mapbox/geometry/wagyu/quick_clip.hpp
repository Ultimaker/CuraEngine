...
template<typename T>
mapbox::geometry::point<T> intersect(mapbox::geometry::point<T> a, mapbox::geometry::point<T> b, size_t edge, mapbox::geometry::box<T> const& box)
{
    switch (edge)
    {
    case 0:
...
template<typename T>
mapbox::geometry::linear_ring<T> quick_lr_clip(mapbox::geometry::linear_ring<T> const& ring, mapbox::geometry::box<T> const& b)
{
...
template<typename T>
mapbox::geometry::multi_polygon<T> clip(mapbox::geometry::polygon<T> const& poly, mapbox::geometry::box<T> const& b, fill_type subject_fill_type)
{
...
template<typename T>
mapbox::geometry::multi_polygon<T> clip(mapbox::geometry::multi_polygon<T> const& mp, mapbox::geometry::box<T> const& b, fill_type subject_fill_type)
{
    mapbox::geometry::multi_polygon<T> result;
    wagyu<T> clipper;
