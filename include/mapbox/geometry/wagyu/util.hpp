...
template<typename T>
bool slopes_equal(mapbox::geometry::point<T> const& pt1, mapbox::geometry::point<T> const& pt2, mapbox::geometry::point<T> const& pt3)
{
...
template<typename T>
bool slopes_equal(mapbox::geometry::wagyu::point<T> const& pt1, mapbox::geometry::wagyu::point<T> const& pt2, mapbox::geometry::point<T> const& pt3)
{
    return static_cast<std::int64_t>(pt1.y - pt2.y) * static_cast<std::int64_t>(pt2.x - pt3.x)
        == static_cast<std::int64_t>(pt1.x - pt2.x) * static_cast<std::int64_t>(pt2.y - pt3.y);
}
...
template<typename T>
bool slopes_equal(mapbox::geometry::wagyu::point<T> const& pt1, mapbox::geometry::wagyu::point<T> const& pt2, mapbox::geometry::wagyu::point<T> const& pt3)
{
    return static_cast<std::int64_t>(pt1.y - pt2.y) * static_cast<std::int64_t>(pt2.x - pt3.x)
        == static_cast<std::int64_t>(pt1.x - pt2.x) * static_cast<std::int64_t>(pt2.y - pt3.y);
}
...
template<typename T>
bool slopes_equal(mapbox::geometry::point<T> const& pt1, mapbox::geometry::point<T> const& pt2, mapbox::geometry::point<T> const& pt3, mapbox::geometry::point<T> const& pt4)
{
