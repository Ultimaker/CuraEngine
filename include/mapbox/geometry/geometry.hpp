...
template<typename T, template<typename...> class Cont = std::vector>
using geometry_base = mapbox::util::
    variant<empty, point<T>, line_string<T, Cont>, polygon<T, Cont>, multi_point<T, Cont>, multi_line_string<T, Cont>, multi_polygon<T, Cont>, geometry_collection<T, Cont>>;
