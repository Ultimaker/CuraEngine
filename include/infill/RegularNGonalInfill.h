 ...
 * \param line_width The Z coordinate of this layer. Different Z coordinates cause the pattern to vary, producing a 3D
 * pattern.
 */
void generateHoneycombInfill(OpenLinesSet& result_lines, const bool zig_zaggify, coord_t line_distance, const Shape& in_outline, const coord_t line_width);
