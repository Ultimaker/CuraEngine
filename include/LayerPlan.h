...
private:
    ...
    bool has_prime_tower_base_planned; //!< Whether the prime tower base is planned yet or not.
    bool has_prime_tower_inset_planned; //!< Whether the prime tower inset is planned yet or not.
