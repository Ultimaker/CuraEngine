...
struct AreaIncreaseSettings
{
    ...
    {
        return
            increase_radius_ == other.increase_radius_ &&
            increase_speed_ == other.increase_speed_ &&
            type_ == other.type_ &&
            no_error_ == other.no_error_ &&
            use_min_distance_ == other.use_min_distance_ &&
            move_ == other.move_;
    }
};
...
struct TreeSupportElement
{
    ...
    TreeSupportElement(TreeSupportElement* element_above) :
        ...
        result_on_layer_(Point(-1, -1)), // set to invalid as we are a new node on a new layer
            ...
            const coord_t foot_increase_radius =
                ...
                (
                    ...
                    (
                        ...
                        getRadius(first.effective_radius_height_, first.buildplate_radius_increases_)) - getRadius(effective_radius_height_, buildplate_radius_increases_
                    )
                );
