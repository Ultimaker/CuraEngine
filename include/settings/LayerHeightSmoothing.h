...
struct LayerHeightSmoothingParams
{
    ...
    LayerHeightSmoothingParams(unsigned int r, bool keep_minimum)
        : radius(r)
        , keep_min(keep_minimum)
    {
    }
};
...
public:
    ...
    static std::vector<coord_t>
        smooth_layer_heights(const std::vector<coord_t>& layer_heights, coord_t min_layer_height, coord_t max_layer_height, const LayerHeightSmoothingParams& smoothing_params);
...
private:
     ...
     */
    static std::vector<coord_t>
        applyGaussianBlur(const std::vector<coord_t>& layer_heights, const std::vector<double>& kernel, coord_t min_layer_height, coord_t max_layer_height, bool keep_min);
};
