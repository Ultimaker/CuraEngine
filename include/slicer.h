...
protected:
     ...
     */
    void makeBasicPolygonLoops(std::vector<OpenPolyline>& open_polylines);
     ...
     */
    void makeBasicPolygonLoop(std::vector<OpenPolyline>& open_polylines, const size_t start_segment_idx);
     ...
     * \param[in,out] open_polylines The polylines which are stiched, but couldn't be closed into a loop
     */
    void connectOpenPolylines(std::vector<OpenPolyline>& open_polylines);
     ...
     */
    void stitch(std::vector<OpenPolyline>& open_polylines);
     ...
     * \param[in,out] open_polylines The polylines which are stiched, but couldn't be closed into a loop yet
     */
    void stitch_extensive(std::vector<OpenPolyline>& open_polylines);
...
private:
     ...
     */
    void planPolylineStitch(const std::vector<OpenPolyline>& open_polylines, Terminus& terminus_0, Terminus& terminus_1, bool reverse[2]) const;
     ...
     */
    void connectOpenPolylinesImpl(std::vector<OpenPolyline>& open_polylines, coord_t max_dist, coord_t cell_size, bool allow_reverse);
};
