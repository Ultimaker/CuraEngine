...
public:
    ...
    EFillMethod pattern { EFillMethod::ZIG_ZAG };
...
BENCHMARK_DEFINE_F(InfillTest, Infill_generateTest)(benchmark::State& st)
{
...
BENCHMARK_REGISTER_F(InfillTest, Infill_generateTest)->Arg(400)->Arg(800)->Arg(1200);
